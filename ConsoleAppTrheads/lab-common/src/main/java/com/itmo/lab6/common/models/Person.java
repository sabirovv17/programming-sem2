...
public class Person implements Comparable<Person>, Serializable {
    ...
    public Person(long id, String name, Coordinates coordinates, LocalDateTime creationDate, long height, Long weight, String passportID, Color color, Location location) {
        this.id = id; 
        this.name = name;
        this.coordinates = coordinates;
        this.creationDate = creationDate;
