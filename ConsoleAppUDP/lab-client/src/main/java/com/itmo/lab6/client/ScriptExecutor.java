                ...
                while ((currentLine = bufferedReader.readLine()) != null) {
                    try {
                        if (currentLine.contains("insert") || currentLine.contains("remove_lower") || currentLine.contains("replace_if_greater") || currentLine.contains("update")) {
                            ...
                            UDPClient.sendRequest(new Request.RequestBuilder().setCommand(currentLine).setPerson(person).build());
                            ...
                            UDPClient.sendRequest(new Request.RequestBuilder().setCommand(currentLine).build());
                            System.out.println(UDPClient.getResponse());
                        }
